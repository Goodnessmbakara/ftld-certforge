            ...
            {user ? (
              <div className="space-y-4">
                <p className="text-lg sm:text-xl text-gray-300 mb-6">
                  Welcome back! Ready to create more certificates?
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="/admin"
                    className="bg-[#00FF7F] hover:bg-[#00CC66] text-black font-bold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
                  >
                  ...
                  <Link
                    href="/students"
                    className="bg-transparent border-2 border-[#00FF7F] text-[#00FF7F] hover:bg-[#00FF7F] hover:text-black font-bold px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center space-x-2"
                  >
              ...
              <div className="space-y-6">
                <p className="text-lg sm:text-xl text-gray-300 mb-6">
                  Join the FTLD community and get your Smart Wallet today!
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    onClick={() => setAuthModalOpen(true)}
                    className="bg-gradient-to-r from-[#00FF7F] to-[#00CC66] hover:from-[#00CC66] hover:to-[#00FF7F] text-black font-bold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
                  >
                    <Sparkles className="w-5 h-5" />
                    <span>Get Started with Smart Wallet</span>
                    <ArrowRight className="w-5 h-5" />
                  </button>
                  <Link
                    href="/verify"
                ...
                <p className="text-sm text-gray-500 mt-4">
                  ✨ Free Smart Wallet • Gasless Transactions • Secure Authentication
                </p>
              </div>
            )}
          </div>
