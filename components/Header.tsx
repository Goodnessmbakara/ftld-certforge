        ...
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
            <div className="w-12 h-12 bg-green-400 rounded-lg flex items-center justify-center">
              {/* FTLD Logo placeholder - replace with actual logo */}
              <span className="text-black font-bold text-xl">F</span>
            </div>
            <div>
              <h1 className="text-2xl font-bold text-white">FTLD CertForge</h1>
              <p className="text-sm text-gray-400">Certificate Generation & Verification</p>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/students" className="text-gray-300 hover:text-green-400 transition-colors">
              Students
            </Link>
            <Link href="/verify" className="text-gray-300 hover:text-green-400 transition-colors">
              Verify
            </Link>
          </nav>
